...
```bash
INIT=$(node "C:/Users/lukasz.bielinski/projects/sleep-tracker/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/lukasz.bielinski/projects/sleep-tracker/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
