...
```
Agent(
  prompt="Read C:/Users/lukasz.bielinski/projects/sleep-tracker/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/lukasz.bielinski/projects/sleep-tracker/.claude/get-shit-done/templates/VALIDATION.md`
