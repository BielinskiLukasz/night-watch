...
INSTALL_JS_GLOBAL="C:/Users/lukasz.bielinski/projects/sleep-tracker/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/lukasz.bielinski/projects/sleep-tracker/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
