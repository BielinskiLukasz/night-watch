...
The keys live in `.claude/settings.json` (project) or `C:/Users/lukasz.bielinski/projects/sleep-tracker/.claude/settings.json` (global) — **not** in `.planning/config.json`:
