...
### Phase 999.1: Time-based bedtime rule (BACKLOG)
...
**Goal:** Predict wake times based on typical sleep duration patterns, not just hour-of-day patterns.
**Requirements:** TBD
**Plans:** 0 plans
...
**Goal:** Track and use contextual "intense day" flags to improve prediction accuracy.
**Requirements:** TBD
**Plans:** 0 plans
...
**Goal:** Use historical nap-skipping patterns to inform bedtime predictions.
**Requirements:** TBD
**Plans:** 0 plans
