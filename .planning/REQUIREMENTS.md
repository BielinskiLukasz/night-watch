...
- [x] **TIF-14**: When TIF is the active algorithm, the Accuracy screen shows a TIF-specific grid with: per-event-type window hit rate ("actual time fell inside TIF window"), average window width in minutes, and percentage of days with confidence score ≥ 80%
