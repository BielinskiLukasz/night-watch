...
number: 1
name: Today screen card order (UI-07)
expected: |
  Open the Today screen. The prediction cards must appear in this exact order from top to bottom:
  wake → nap start → nap end → bedtime. Bedtime card renders last, nap start and nap end in the middle.
